...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'shoppingcart_order', 'count')

        # Deleting field 'Order.product'
        db.delete_column(u'shoppingcart_order', 'product_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'shoppingcart_order', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Order.product'
        db.add_column(u'shoppingcart_order', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['shoppingcart.Product']),
                      keep_default=False)
